...
public class PreorderMorrisTraversal {
   ...
   * i. 如果predecessor的右子节点为空，将其右子节点指向curr，访问curr，将curr指向其左子节点
   * ii. 如果predecessor的右子节点指向curr，说明左子树已遍历完毕，将其右子节点恢复为空，将curr指向其右子节点
   * 4. 重复步骤3，直到curr为空
   */
  ...
  public List<Integer> preorderTraversal(TreeNode root) {
    ...
    while (curr != null) {
      ...
      if (curr.left == null) {
        ...
        // 如果前驱节点的右子节点为空，将其右子节点指向当前节点，访问当前节点，然后将当前节点指向其左子节点
        if (predecessor.right == null) {
          ...
          // 如果前驱节点的右子节点指向当前节点，说明左子树已遍历完毕，将其右子节点恢复为空，然后将当前节点指向其右子节点
          // 将前驱节点的右子节点恢复为空，删除线索
