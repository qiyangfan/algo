...
/**
 * 测试类: InorderIterativeTraversal
 * 使用JUnit 5测试二叉树中序迭代遍历算法的正确性
 */
class InorderIterativeTraversalTest {
    ...
    void testStandardBinaryTree() {
        // 准备测试数据
        InorderIterativeTraversal traversal = new InorderIterativeTraversal();
