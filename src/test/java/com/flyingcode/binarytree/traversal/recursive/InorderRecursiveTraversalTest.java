...
/**
 * 测试类: InorderRecursiveTraversal
 * 使用JUnit 5测试二叉树中序递归遍历算法的正确性
 */
class InorderRecursiveTraversalTest {
    ...
    void testStandardBinaryTree() {
        // 准备测试数据
        InorderRecursiveTraversal traversal = new InorderRecursiveTraversal();
    ...
    void testLeftSkewedTree() {
        ...
        // 验证结果
        assertNotNull(result, "返回结果不应为null");
        assertEquals(expected, result, "左斜树的中序遍历结果应该是[1,2,3,4]");
    }
    ...
    void testRightSkewedTree() {
        ...
        // 验证结果
        assertNotNull(result, "返回结果不应为null");
        assertEquals(expected, result, "右斜树的中序遍历结果应该是[1,2,3,4]");
    }
}