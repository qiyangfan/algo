...
/**
 * 测试类: Algo010MaxProductThreeScan
 * 使用 JUnit 5 测试线性扫描三个数最大乘积算法的正确性
 */
class Algo010MaxProductThreeScanTest {
    ...
    void testAllPositiveNumbers() {
        Algo010MaxProductThreeScan algo = new Algo010MaxProductThreeScan();
        int[] nums = { 1, 2, 3 };
