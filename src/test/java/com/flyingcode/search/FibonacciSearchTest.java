...
class FibonacciSearchTest {
    ...
    void testAllSameElementsWithExistingElement() {
        ...
        // 验证结果
        assertEquals(2, result, "所有元素相同的数组[5,5,5,5,5]中查找5，应该返回中间索引");
    }
    ...
    void testUniformlyDistributedLongArray() {
        ...
        // 验证结果
        assertEquals(expected, result, "均匀分布的长数组中查找98，应该返回索引49");
    }
    ...
    void testNonUniformlyDistributedArray() {
        ...
        // 验证结果
        assertEquals(expected, result, "非均匀分布的数组[1,2,4,8,16,32,64,128,256,512]中查找64，应该返回索引6");
    }
}